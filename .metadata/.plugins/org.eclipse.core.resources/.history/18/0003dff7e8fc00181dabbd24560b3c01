...
public class ConsultarAlfajor extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JTextField txtTxtprecio;
	...
	public ConsultarAlfajor() {
		...
		txtTxtprecio = new JTextField();
		txtTxtprecio.setBounds(112, 33, 86, 20);
		contentPanel.add(txtTxtprecio);
		txtTxtprecio.setColumns(10);
		...
		cboMarca.setModel(new DefaultComboBoxModel(new String[] {"Alfano", "Delicia", "Vimar"}));
